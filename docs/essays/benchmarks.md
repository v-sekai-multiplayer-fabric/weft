...
5.5 ms in this container. A synchronous FoundationDB write costs 1.9 ms, so _the
fsyncing local store is slower than the network database_. That inverts the usual
