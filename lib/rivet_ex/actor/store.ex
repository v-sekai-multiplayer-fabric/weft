defmodule RivetEx.Actor.Store do
  @moduledoc """
  ...
  SQLite-backed actor storage plugs in; `RivetEx.Actor.Store.Sqlite` is the
  default, and CubDB or a remote backend can implement the same behaviour.
  """

  @type handle :: term()

  @callback open(RivetEx.Actor.id()) :: {:ok, handle()} | {:error, term()}
  ...
  @spec impl() :: module()
  def impl, do: Application.get_env(:rivet_ex, :actor_store, RivetEx.Actor.Store.Sqlite)
end
